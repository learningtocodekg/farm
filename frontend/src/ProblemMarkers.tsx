...
export const PROBLEMS: Problem[] = [
  {
    ...
    type: 'weed',
    label: 'Pigweed',
    position: [0.796, 0, -1.2935],
    severity: 'high',
    detail: 'Sector 4A · Row 2 · 95% conf.',
    color: '#ba1a1a',
    badge: 'WEED',
  },
  {
    ...
    type: 'weed',
    label: 'Crabgrass',
    position: [-2.0486, 0, 2.0052],
    severity: 'medium',
    detail: 'Sector 2B · Row 3 · 88% conf.',
    color: '#b97b00',
    badge: 'WEED',
  },
  {
    ...
    type: 'pest',
    label: 'Pest Activity',
    position: [-0.3588, 0, 1.8875],
    severity: 'medium',
    detail: 'Sector 3C · Soil damage detected',
    color: '#b97b00',
    badge: 'PEST',
  },
  {
    id: 'sprinkler',
    type: 'sprinkler',
    label: 'Sprinkler Fault',
    position: [-1.6372, 0, 1.5809],
    severity: 'low',
    detail: 'Zone 2 · Flow sensor anomaly',
    color: '#00658f',
    badge: 'WATER',
  },
];
